...
class TrafficLight(object):
    ...
    valid_states = [True, False]  # True = NS open; False = EW open, belongs to class, shared by all instances

    def __init__(self, state=None, period=None):   #belongs to instance of a class
...
class Environment(object):
    ...
    def create_agent(self, agent_class, *args, **kwargs):  
        #*args allows to pass a variable nbr of arguments into the function and could be anything.
        #**kwargs allows to pass a keyworded variable nbr of arguments into the function, i.e. with key and value
        #  so need to specify the key and value of the argument when you pass it in. eg. name=="yasoob" or 
        #  {"name": "yasoob}
